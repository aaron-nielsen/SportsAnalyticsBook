...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-16-2.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pitchers2021 }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{Player) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ggpairs}\NormalTok{(}\AttributeTok{title=}\StringTok{"Correlation plot of pitching statistics, MLB 2020{-}2021"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{eFG }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{((FG }\SpecialCharTok{+}\NormalTok{ .}\DecValTok{5} \SpecialCharTok{*}\NormalTok{ THREEP)}\SpecialCharTok{/}\NormalTok{FGA, }\DecValTok{3}\NormalTok{) }\SpecialCharTok{*} \DecValTok{100}
\NormalTok{TOVPCT }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(TOV }\SpecialCharTok{/}\NormalTok{ (FGA }\SpecialCharTok{+}\NormalTok{ .}\DecValTok{44} \SpecialCharTok{*}\NormalTok{ FTA }\SpecialCharTok{+}\NormalTok{ TOV), }\DecValTok{3}\NormalTok{) }\SpecialCharTok{*} \DecValTok{100}
...
\NormalTok{basketball\_data }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{add\_column}\NormalTok{(eFG, TOVPCT, ORBPCT, FTFACTOR) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{kt}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{xGoal\_stats }\OtherTok{\textless{}{-}}\NormalTok{ nhl\_data\_all }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(shotsOnGoalFor, corsiPercentage, fenwickPercentage, xGoalsPercentage)}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-33-2.pdf}
...
\NormalTok{team\_goals\_viz }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ liga\_2021\_stats[}\FunctionTok{which}\NormalTok{(liga\_2021\_stats}\SpecialCharTok{$}\NormalTok{Team\_or\_Opponent }\SpecialCharTok{==} \StringTok{"team"}\NormalTok{),], }
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-38-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-49-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-54-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{shaqFTA }\OtherTok{\textless{}{-}}\NormalTok{ shaq9798 }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(FTA)}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{dmultinom}\NormalTok{(}\AttributeTok{x =} \FunctionTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{), }\AttributeTok{prob =} \FunctionTok{c}\NormalTok{(.}\DecValTok{61}\NormalTok{, .}\DecValTok{16}\NormalTok{, .}\DecValTok{03}\NormalTok{, .}\DecValTok{20}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-74-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-77-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-80-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-82-1.pdf}
...
\textbf{\emph{Simulation 1: Bankroll after 10 bets}}
...
\textbf{\emph{Simulation 2: Bankroll after 100 bets}}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-88-1.pdf}

\newpage

\textbf{\emph{Simulation 3: Bankroll after 1000 bets}}
...
All bettors eventually go broke under this scenario due to the house advantage. This is called the concept of \textbf{Gambler's Ruin}. A gambler playing a game with negative expected value will eventually go broke, regardless of their betting system. See Wikipedia for further details: \url{https://en.wikipedia.org/wiki/Gambler's_ruin}
...
\hypertarget{extra-stuff-1}{%
\section{Extra stuff}\label{extra-stuff-1}}

\hypertarget{shaq-ft-simulation}{%
\subsection{Shaq FT simulation}\label{shaq-ft-simulation}}
...
\NormalTok{  temp }\OtherTok{\textless{}{-}} \FunctionTok{rnbinom}\NormalTok{(}\AttributeTok{n =}\NormalTok{ games.sim[i],}\AttributeTok{size =} \FloatTok{25.85}\NormalTok{,}\AttributeTok{prob =} \DecValTok{1}\FloatTok{{-}0.305}\NormalTok{)}
\NormalTok{  FT[i] }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(temp)}
\NormalTok{\}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{FT }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{as.data.frame}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{FT)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_histogram}\NormalTok{(}\AttributeTok{bins=}\DecValTok{30}\NormalTok{,}\AttributeTok{color =} \StringTok{"yellow"}\NormalTok{, }\AttributeTok{fill =} \StringTok{"purple"}\NormalTok{) }\SpecialCharTok{+}
