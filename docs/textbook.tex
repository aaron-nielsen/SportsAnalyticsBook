...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mlb\_comp }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Yes =} \FunctionTok{c}\NormalTok{(}\StringTok{" "}\NormalTok{, }\StringTok{" "}\NormalTok{, }\DecValTok{128}\NormalTok{), }\AttributeTok{No =} \FunctionTok{c}\NormalTok{(}\StringTok{" "}\NormalTok{, }\StringTok{" "}\NormalTok{, }\DecValTok{4732}\NormalTok{), }\AttributeTok{Total =} \FunctionTok{c}\NormalTok{(}\DecValTok{2592}\NormalTok{,}\DecValTok{2268}\NormalTok{, }\DecValTok{4860}\NormalTok{))}
\FunctionTok{row.names}\NormalTok{(mlb\_comp) }\OtherTok{=} \FunctionTok{c}\NormalTok{(}\StringTok{"NL"}\NormalTok{, }\StringTok{"AL"}\NormalTok{,}\StringTok{"Total"}\NormalTok{)}

\NormalTok{mlb\_comp }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{kable}\NormalTok{(}\AttributeTok{booktabs=}\NormalTok{T,}\AttributeTok{digits =} \DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{table}\NormalTok{(small\_corr) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{kable}\NormalTok{(}\AttributeTok{booktabs=}\NormalTok{T,}\AttributeTok{digits =} \DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(small\_corr)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{table}\NormalTok{(large\_corr1) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{kable}\NormalTok{(}\AttributeTok{booktabs=}\NormalTok{T,}\AttributeTok{digits =} \DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(large\_corr1)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{table}\NormalTok{(large\_corr2) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{kable}\NormalTok{(}\AttributeTok{booktabs=}\NormalTok{T,}\AttributeTok{digits =} \DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(large\_corr2)}
\end{Highlighting}
\end{Shaded}
...
\chapter{Pythagorean Record}\label{pythagorean-record}}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-142-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-143-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-144-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-153-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-155-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-156-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-159-1.pdf}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-160-1.pdf}
...
More about Ohtani's pitching repertoire: \url{https://www.youtube.com/watch?v=7nZBlYIqEww}
\end{example}
...
\NormalTok{colors }\OtherTok{\textless{}{-}} \FunctionTok{brewer.pal}\NormalTok{(}\AttributeTok{n =} \DecValTok{12}\NormalTok{, }\AttributeTok{name =} \StringTok{"Paired"}\NormalTok{)}
\NormalTok{pitch\_colors }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"4{-}Seam Fastball"} \OtherTok{=}\NormalTok{ colors[}\DecValTok{1}\NormalTok{],}
                  \StringTok{"2{-}Seam Fastball"} \OtherTok{=}\NormalTok{ colors[}\DecValTok{2}\NormalTok{],}
                  \StringTok{"Sinker"} \OtherTok{=}\NormalTok{ colors[}\DecValTok{3}\NormalTok{],}
                  \StringTok{"Cutter"} \OtherTok{=}\NormalTok{ colors[}\DecValTok{4}\NormalTok{],}
                  \StringTok{"Fastball"} \OtherTok{=}\NormalTok{ colors[}\DecValTok{5}\NormalTok{],}
                  \StringTok{"Curveball"} \OtherTok{=}\NormalTok{ colors[}\DecValTok{6}\NormalTok{],}
                  \StringTok{"Knuckle Curve"} \OtherTok{=}\NormalTok{ colors[}\DecValTok{7}\NormalTok{],}
                  \StringTok{"Slider"} \OtherTok{=}\NormalTok{ colors[}\DecValTok{8}\NormalTok{],}
                  \StringTok{"Changeup"} \OtherTok{=}\NormalTok{ colors[}\DecValTok{9}\NormalTok{],}
                  \StringTok{"Split{-}Finger"} \OtherTok{=}\NormalTok{ colors[}\DecValTok{10}\NormalTok{],}
                  \StringTok{"Knuckleball"} \OtherTok{=}\NormalTok{ colors[}\DecValTok{11}\NormalTok{])}
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-166-1.pdf}
...
\NormalTok{ohtani\_velo\_by\_inning }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{size =} \FloatTok{1.5}\NormalTok{, }\AttributeTok{alpha =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{show.legend =} \ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{+}
...
\begin{verbatim}
## [17:42:19] WARNING: amalgamation/../src/learner.cc:438: 
...
\includegraphics{textbook_files/figure-latex/unnamed-chunk-170-1.pdf}
