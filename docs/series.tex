...
\hypertarget{basic-baseball-hitting-statistics}{%
\subsection{Basic Baseball Hitting Statistics}\label{basic-baseball-hitting-statistics}}
...
\hypertarget{basic-baseball-hitting-statistics-1}{%
\subsection{Basic Baseball Hitting Statistics}\label{basic-baseball-hitting-statistics-1}}
...
More about WAR from \href{https://library.fangraphs.com/misc/war/}{Fangraphs}

\emph{References: \url{https://www.baseball-reference.com/bullpen/Baseball_statistics}, \url{https://blogs.fangraphs.com/glossary/}, \url{https://library.fangraphs.com/fangraphs-library-glossary/}}
...
\FunctionTok{head}\NormalTok{(rox21)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{rox21 }\OtherTok{\textless{}{-}}\NormalTok{ rox21 }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{AVG =} \FunctionTok{round}\NormalTok{(H}\SpecialCharTok{/}\NormalTok{AB, }\DecValTok{3}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{OBA =} \FunctionTok{round}\NormalTok{((H }\SpecialCharTok{+}\NormalTok{ BB }\SpecialCharTok{+}\NormalTok{ HBP)}\SpecialCharTok{/}\NormalTok{(AB }\SpecialCharTok{+}\NormalTok{ BB }\SpecialCharTok{+}\NormalTok{ HBP }\SpecialCharTok{+}\NormalTok{ SF), }\DecValTok{3}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{SLG =} \FunctionTok{round}\NormalTok{(((H }\SpecialCharTok{{-}} \StringTok{\textasciigrave{}}\AttributeTok{2B}\StringTok{\textasciigrave{}} \SpecialCharTok{{-}} \StringTok{\textasciigrave{}}\AttributeTok{3B}\StringTok{\textasciigrave{}} \SpecialCharTok{{-}}\NormalTok{ HR) }\SpecialCharTok{+} \DecValTok{2} \SpecialCharTok{*} \StringTok{\textasciigrave{}}\AttributeTok{2B}\StringTok{\textasciigrave{}} \SpecialCharTok{+} \DecValTok{3} \SpecialCharTok{*} \StringTok{\textasciigrave{}}\AttributeTok{3B}\StringTok{\textasciigrave{}} \SpecialCharTok{+} \DecValTok{4} \SpecialCharTok{*}\NormalTok{ HR)}\SpecialCharTok{/}\NormalTok{AB,}
        \DecValTok{3}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{OPS =} \FunctionTok{round}\NormalTok{(SLG }\SpecialCharTok{+}\NormalTok{ OBA, }\DecValTok{3}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{wOBA =} \FunctionTok{round}\NormalTok{((}\FloatTok{0.692} \SpecialCharTok{*}\NormalTok{ (BB }\SpecialCharTok{{-}}\NormalTok{ IBB) }\SpecialCharTok{+} \FloatTok{0.722} \SpecialCharTok{*}\NormalTok{ HBP }\SpecialCharTok{+} \FloatTok{0.879} \SpecialCharTok{*}\NormalTok{ (H }\SpecialCharTok{{-}} \StringTok{\textasciigrave{}}\AttributeTok{2B}\StringTok{\textasciigrave{}} \SpecialCharTok{{-}} \StringTok{\textasciigrave{}}\AttributeTok{3B}\StringTok{\textasciigrave{}} \SpecialCharTok{{-}}
\NormalTok{        HR) }\SpecialCharTok{+} \FloatTok{1.242} \SpecialCharTok{*} \StringTok{\textasciigrave{}}\AttributeTok{2B}\StringTok{\textasciigrave{}} \SpecialCharTok{+} \FloatTok{1.568} \SpecialCharTok{*} \StringTok{\textasciigrave{}}\AttributeTok{3B}\StringTok{\textasciigrave{}} \SpecialCharTok{+} \FloatTok{2.007} \SpecialCharTok{*}\NormalTok{ HR)}\SpecialCharTok{/}\NormalTok{(AB }\SpecialCharTok{+}\NormalTok{ BB }\SpecialCharTok{{-}}\NormalTok{ IBB }\SpecialCharTok{+}\NormalTok{ SF }\SpecialCharTok{+}\NormalTok{ HBP),}
        \DecValTok{3}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{ISO =} \FunctionTok{round}\NormalTok{(SLG }\SpecialCharTok{{-}}\NormalTok{ AVG, }\DecValTok{3}\NormalTok{))}
\NormalTok{rox21 }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{select}\NormalTok{(Name, PA, AVG, OBA, SLG, OPS, wOBA, ISO)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{series_files/figure-latex/unnamed-chunk-12-2.pdf}
...
\emph{References: \url{https://www.basketball-reference.com/about/per.html}, \url{https://www.basketball-reference.com/about/ws.html}, \url{https://www.basketball-reference.com/about/glossary.html}}
...
\NormalTok{basketball\_data }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{add\_column}\NormalTok{(eFG, TOVPCT, ORBPCT, FTFACTOR)}
\end{Highlighting}
\end{Shaded}
...
## # ... with 1 more variable: FTFACTOR <dbl>
\end{verbatim}
...
\subsection{BasketballAnalyzeR Four Factors}\label{basketballanalyzer-four-factors}}
...
\FunctionTok{print}\NormalTok{(four\_factors\_teams)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{basketballanalyzer-shot-charts}{%
\subsection{BasketballAnalyzeR Shot Charts}\label{basketballanalyzer-shot-charts}}
...
\includegraphics{series_files/figure-latex/basketballanalyzer 7-1.pdf}
...
\emph{References: \url{https://rdrr.io/cran/BasketballAnalyzeR/}; Basketball Data Science (Zuccolotto and Manisera, 2020)}
...
\emph{Reference: \url{https://www.milehighhockey.com/pages/stats}}
...
\emph{References: \url{https://www.nhl.com/lightning/news/hockey-analytics-101-understanding-advanced-stats-and-how-theyre-measured/c-735819}, \url{https://theathletic.com/121980/2017/10/09/an-advanced-stat-primer-understanding-basic-hockey-metrics/}}
...
\FunctionTok{head}\NormalTok{(goalie\_data)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{filtered\_goalie\_data }\SpecialCharTok{\%\textgreater{}\%}
    ...
    \FunctionTok{select}\NormalTok{(Player, Team, GAA)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{filtered\_goalie\_data }\SpecialCharTok{\%\textgreater{}\%}
    ...
    \FunctionTok{select}\NormalTok{(Player, Team, TOI)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{series_files/figure-latex/unnamed-chunk-23-2.pdf}
...
\includegraphics{series_files/figure-latex/unnamed-chunk-24-2.pdf}
...
\includegraphics{series_files/figure-latex/unnamed-chunk-43-1.pdf}
...
\includegraphics{series_files/figure-latex/unnamed-chunk-44-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{shaq.mean }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(shaqFTA}\SpecialCharTok{$}\NormalTok{FTA)}
\NormalTok{shaq.var }\OtherTok{\textless{}{-}} \FunctionTok{var}\NormalTok{(shaqFTA}\SpecialCharTok{$}\NormalTok{FTA)}
...
\includegraphics{series_files/figure-latex/unnamed-chunk-48-1.pdf}
...
\includegraphics{series_files/figure-latex/unnamed-chunk-56-1.pdf}
...
\NormalTok{n.sims }\OtherTok{\textless{}{-}} \DecValTok{10000}
\NormalTok{FT }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, n.sims)}
\NormalTok{shaq.games }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{51}\NormalTok{, }\DecValTok{60}\NormalTok{, }\DecValTok{49}\NormalTok{, }\DecValTok{79}\NormalTok{, }\DecValTok{74}\NormalTok{, }\DecValTok{67}\NormalTok{, }\DecValTok{67}\NormalTok{, }\DecValTok{67}\NormalTok{)}
\NormalTok{shaq.FTA }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"data/shaqFT.csv"}\NormalTok{, }\AttributeTok{col\_names =} \ConstantTok{FALSE}\NormalTok{)}
\NormalTok{shaq.FTA }\OtherTok{\textless{}{-}}\NormalTok{ shaq.FTA}\SpecialCharTok{$}\NormalTok{X1}

\CommentTok{\# sample (with replacement) from Shaq\textquotesingle{}s FTA game totals}
\NormalTok{games.sim }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(}\AttributeTok{x =}\NormalTok{ shaq.games, }\AttributeTok{size =}\NormalTok{ n.sims, }\AttributeTok{replace =}\NormalTok{ T)}

\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{n.sims) \{}
    \CommentTok{\# sample (with replacement) from Shaq\textquotesingle{}s FTA game totals}
\NormalTok{    temp }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(}\AttributeTok{x =}\NormalTok{ shaq.FTA, }\AttributeTok{size =}\NormalTok{ games.sim[i], }\AttributeTok{replace =}\NormalTok{ T)}
\NormalTok{    FT[i] }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(temp)}
\NormalTok{\}}
...
\includegraphics{series_files/figure-latex/unnamed-chunk-60-1.pdf}
...
\section{wnba scraping}\label{wnba-scraping}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wilson }\OtherTok{\textless{}{-}} \StringTok{"https://www.basketball{-}reference.com/wnba/players/w/wilsoa01w/gamelog/2022/"}
\NormalTok{wil\_doc }\OtherTok{\textless{}{-}}\NormalTok{ rvest}\SpecialCharTok{::}\FunctionTok{read\_html}\NormalTok{(wilson)}

\NormalTok{wil\_doc }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    rvest}\SpecialCharTok{::}\FunctionTok{html\_elements}\NormalTok{(., }\AttributeTok{xpath =} \StringTok{"//*[(@id = \textquotesingle{}div\_wnba\_pgl\_basic\textquotesingle{})]"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    rvest}\SpecialCharTok{::}\FunctionTok{html\_table}\NormalTok{() }\OtherTok{{-}\textgreater{}}\NormalTok{ wil}
\NormalTok{wil }\OtherTok{\textless{}{-}}\NormalTok{ wil[[}\DecValTok{1}\NormalTok{]]}
\FunctionTok{head}\NormalTok{(wil)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# wil2 \textless{}{-} mutate\_all(wil, function(x) as.numeric(as.character(x)))}
\CommentTok{\# mean(wil2[\textquotesingle{}PTS\textquotesingle{}])}

\CommentTok{\# wil$eFG\textless{}{-} (wil[\textquotesingle{}FG\textquotesingle{}] + (0.5*wil[\textquotesingle{}3P\textquotesingle{}]))/wil[\textquotesingle{}FGA\textquotesingle{}] wil$eFG}
\CommentTok{\# ![Screenshot](\textquotesingle{}\textasciitilde{}/Google Drive/My Drive/Sports}
\CommentTok{\# Analytics/SportsAnalyticsBook/images/scraping1\textquotesingle{})}
\end{Highlighting}
\end{Shaded}
