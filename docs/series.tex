...
\CommentTok{\# You shouldn\textquotesingle{}t need to load the ggplot2 package separately if the tidyverse package loads properly}
...
Possible dataset: \href{https://www.pro-football-reference.com/years/2021/index.htm\#passing}{NFL Team Passing Statistics, 2021}
