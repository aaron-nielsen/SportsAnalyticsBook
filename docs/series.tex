...
\section{Hockey - ggplot}\label{hockey---ggplot}}
...
\FunctionTok{View}\NormalTok{(nhl\_2022\_data)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{View}\NormalTok{(nhl\_data\_all)}
...
\section{Sets and Conditional Probability}\label{sets-and-conditional-probability}}
...
\section{Binomial Probability}\label{binomial-probability}}
...
\section{Binomial Coefficient Symmetry}\label{binomial-coefficient-symmetry}}
...
\section{Binomials and Multinomials}\label{binomials-and-multinomials}}
...
\section{Geometric (First Success) RVs}\label{geometric-first-success-rvs}}
...
\section{Geometric Distribution - Hockey}\label{geometric-distribution---hockey}}
