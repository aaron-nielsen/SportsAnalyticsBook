...
\includegraphics{series_files/figure-latex/unnamed-chunk-68-1.pdf}
...
\hypertarget{hit-streak-simulation}{%
\section{Hit Streak Simulation}\label{hit-streak-simulation}}

\begin{example}
In 1941, Joe DiMaggio had a 56-game hitting streak which is an all-time record in MLB. How unlikely was such an outcome? Let's build a simulation to estimate the probability of a 56-game hitting streak using DiMaggio's statistics.
...
The probability of DiMaggio getting at least one hit in a 4 plate appearance game is: \$P(one , or , more , hits) = 1 - P(no hit) = 1-0.69\^{}4 = 0.7733.

The probability of DiMaggio getting at least one hit in a 5 plate appearance game is: \$P(one , or , more , hits) = 1 - P(no hit) = 1-0.69\^{}5 = 0.8436.
\end{example}
...
\NormalTok{p4 }\OtherTok{\textless{}{-}} \FloatTok{0.7733}
\NormalTok{p5 }\OtherTok{\textless{}{-}} \FloatTok{0.8436}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{hist}\NormalTok{(longest.streak)}
\end{Highlighting}
\end{Shaded}
