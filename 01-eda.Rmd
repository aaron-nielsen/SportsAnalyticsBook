...
# You shouldn't need to load the ggplot2 package separately if the tidyverse package loads properly
# library(ggplot2)
...
Possible dataset: [NFL Team Passing Statistics, 2021](https://www.pro-football-reference.com/years/2021/index.htm#passing)
