...
\NormalTok{down4 =}\StringTok{ }\KeywordTok{filter}\NormalTok{(nfl2, nfl2[}\StringTok{'down'}\NormalTok{]}\OperatorTok{==}\DecValTok{4}\NormalTok{)}
\NormalTok{down4 <-}\StringTok{ }\NormalTok{down4 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(PlayType}\OperatorTok{!=}\StringTok{ 'Punt'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(PlayType}\OperatorTok{!=}\StringTok{ 'No Play'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(PlayType}\OperatorTok{!=}\StringTok{ 'QB Kneel'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(PlayType}\OperatorTok{!=}\StringTok{ 'Timeout'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{GoForIt =} \KeywordTok{case_when}\NormalTok{(}
\NormalTok{    PlayType }\OperatorTok{==}\StringTok{ 'Pass'} \OperatorTok{~}\StringTok{ }\DecValTok{1}\NormalTok{,}
\NormalTok{    PlayType }\OperatorTok{==}\StringTok{ 'Run'} \OperatorTok{~}\StringTok{ }\DecValTok{1}\NormalTok{,}
\NormalTok{    PlayType }\OperatorTok{==}\StringTok{ 'Sack'} \OperatorTok{~}\StringTok{ }\DecValTok{1}\NormalTok{,}
\NormalTok{    PlayType }\OperatorTok{==}\StringTok{ 'Field Goal'} \OperatorTok{~}\StringTok{ }\DecValTok{0} 
\NormalTok{  ))}

\NormalTok{down4 <-}\StringTok{ }\NormalTok{down4 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Success =} \KeywordTok{case_when}\NormalTok{(}
\NormalTok{    FieldGoalResult }\OperatorTok{==}\StringTok{ 'Good'} \OperatorTok{~}\StringTok{ }\DecValTok{1}\NormalTok{,}
\NormalTok{    FirstDown }\OperatorTok{==}\StringTok{ }\DecValTok{1} \OperatorTok{~}\StringTok{ }\DecValTok{1}\NormalTok{,}
    \OtherTok{TRUE} \OperatorTok{~}\StringTok{ }\DecValTok{0}
\NormalTok{  ))}
\NormalTok{down5 <-}\StringTok{ }\NormalTok{down4 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(yrdline100) }\OperatorTok{%>%}
\StringTok{        }\KeywordTok{group_by}\NormalTok{(Success) }\OperatorTok{%>%}
\StringTok{          }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{Count =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}
\StringTok{          }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Percentage=}\NormalTok{Count}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(Count))}

\KeywordTok{head}\NormalTok{(down5)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\StringTok{'}
\StringTok{down5<- down4 %>%}
\StringTok{  group_by(yrdline100) %>%}
\StringTok{    group_by(ydstogo) %>%}
\StringTok{      group_by(GoForIt) %>%}
\StringTok{        group_by(Success) %>%}
\StringTok{          summarize(Count = n()) %>%}
\StringTok{          mutate(Percentage=Count/sum(Count))}
\StringTok{'}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{## for each (grouping of 10 yards?) we get all the 4th down playtypes of fieldgoal and normal plays and see probability of success for each option, for each group}
\CommentTok{# filter by only plays on 4th down}
\NormalTok{down4 =}\StringTok{ }\KeywordTok{filter}\NormalTok{(nfl2, nfl2[}\StringTok{'down'}\NormalTok{]}\OperatorTok{==}\DecValTok{4}\NormalTok{)}
...
\KeywordTok{colnames}\NormalTok{(df29_}\DecValTok{20}\NormalTok{) <-}\StringTok{ }\NormalTok{x}
\NormalTok{df19_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{matrix}\NormalTok{(}\DataTypeTok{ncol =} \DecValTok{2}\NormalTok{, }\DataTypeTok{nrow =} \DecValTok{0}\NormalTok{))}
\KeywordTok{colnames}\NormalTok{(df19_}\DecValTok{10}\NormalTok{) <-}\StringTok{ }\NormalTok{x}
\NormalTok{df09_}\DecValTok{00}\NormalTok{ <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{matrix}\NormalTok{(}\DataTypeTok{ncol =} \DecValTok{2}\NormalTok{, }\DataTypeTok{nrow =} \DecValTok{0}\NormalTok{))}
\KeywordTok{colnames}\NormalTok{(df09_}\DecValTok{00}\NormalTok{) <-}\StringTok{ }\NormalTok{x}



\CommentTok{## create final dataframe with 3 columns: distance to goal, field goal probability, td probability}
\CommentTok{#df_prob <- data.frame(matrix(ncol = 3, nrow = 0))}
\CommentTok{#y = c('distance_to_goal','fg_prob','td_prob')}
\CommentTok{#colnames(df_prob) <- x}
\CommentTok{#down3 %>%}
\CommentTok{#  group_split(yrdline100)}

\NormalTok{down3 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{distance =} \KeywordTok{case_when}\NormalTok{(down3[}\StringTok{'yrdline100'}\NormalTok{]}\OperatorTok{<}\DecValTok{100} \OperatorTok{&}\StringTok{ }\NormalTok{down3[}\StringTok{'yrdline100'}\NormalTok{] }\OperatorTok{>}\DecValTok{89} \OperatorTok{~}\StringTok{ }\DecValTok{90}\NormalTok{,}
\NormalTok{                           down3[}\StringTok{'yrdline100'}\NormalTok{]}\OperatorTok{<}\DecValTok{90} \OperatorTok{&}\StringTok{ }\NormalTok{down3[}\StringTok{'yrdline100'}\NormalTok{] }\OperatorTok{>}\DecValTok{79} \OperatorTok{~}\StringTok{ }\DecValTok{80}\NormalTok{,}
\NormalTok{                           down3[}\StringTok{'yrdline100'}\NormalTok{]}\OperatorTok{<}\DecValTok{80} \OperatorTok{&}\StringTok{ }\NormalTok{down3[}\StringTok{'yrdline100'}\NormalTok{] }\OperatorTok{>}\DecValTok{69} \OperatorTok{~}\StringTok{ }\DecValTok{70}\NormalTok{,}
\NormalTok{                           down3[}\StringTok{'yrdline100'}\NormalTok{]}\OperatorTok{<}\DecValTok{70} \OperatorTok{&}\StringTok{ }\NormalTok{down3[}\StringTok{'yrdline100'}\NormalTok{] }\OperatorTok{>}\DecValTok{59} \OperatorTok{~}\StringTok{ }\DecValTok{60}\NormalTok{,}
\NormalTok{                           down3[}\StringTok{'yrdline100'}\NormalTok{]}\OperatorTok{<}\DecValTok{60} \OperatorTok{&}\StringTok{ }\NormalTok{down3[}\StringTok{'yrdline100'}\NormalTok{] }\OperatorTok{>}\DecValTok{49} \OperatorTok{~}\StringTok{ }\DecValTok{50}\NormalTok{,}
\NormalTok{                           down3[}\StringTok{'yrdline100'}\NormalTok{]}\OperatorTok{<}\DecValTok{50} \OperatorTok{&}\StringTok{ }\NormalTok{down3[}\StringTok{'yrdline100'}\NormalTok{] }\OperatorTok{>}\DecValTok{39} \OperatorTok{~}\StringTok{ }\DecValTok{40}\NormalTok{,}
\NormalTok{                           down3[}\StringTok{'yrdline100'}\NormalTok{]}\OperatorTok{<}\DecValTok{40} \OperatorTok{&}\StringTok{ }\NormalTok{down3[}\StringTok{'yrdline100'}\NormalTok{] }\OperatorTok{>}\DecValTok{29} \OperatorTok{~}\StringTok{ }\DecValTok{30}\NormalTok{,}
\NormalTok{                           down3[}\StringTok{'yrdline100'}\NormalTok{]}\OperatorTok{<}\DecValTok{30} \OperatorTok{&}\StringTok{ }\NormalTok{down3[}\StringTok{'yrdline100'}\NormalTok{] }\OperatorTok{>}\DecValTok{19} \OperatorTok{~}\StringTok{ }\DecValTok{20}\NormalTok{,}
\NormalTok{                           down3[}\StringTok{'yrdline100'}\NormalTok{]}\OperatorTok{<}\DecValTok{20} \OperatorTok{&}\StringTok{ }\NormalTok{down3[}\StringTok{'yrdline100'}\NormalTok{] }\OperatorTok{>}\DecValTok{9} \OperatorTok{~}\StringTok{ }\DecValTok{10}\NormalTok{,}
\NormalTok{                           down3[}\StringTok{'yrdline100'}\NormalTok{]}\OperatorTok{<}\DecValTok{10} \OperatorTok{~}\StringTok{ }\DecValTok{0}
\NormalTok{    )) ->}\StringTok{ }\NormalTok{down3}
\NormalTok{down3 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_split}\NormalTok{(distance) ->}\StringTok{ }\NormalTok{yrd_df}

\NormalTok{df99_}\DecValTok{90}\NormalTok{ <-}\StringTok{ }\NormalTok{yrd_df[[}\DecValTok{10}\NormalTok{]]}
\NormalTok{df89_}\DecValTok{80}\NormalTok{ <-}\StringTok{ }\NormalTok{yrd_df[[}\DecValTok{9}\NormalTok{]]}
\NormalTok{df79_}\DecValTok{70}\NormalTok{ <-}\StringTok{ }\NormalTok{yrd_df[[}\DecValTok{8}\NormalTok{]]}
\NormalTok{df69_}\DecValTok{60}\NormalTok{ <-}\StringTok{ }\NormalTok{yrd_df[[}\DecValTok{7}\NormalTok{]]}
\NormalTok{df59_}\DecValTok{50}\NormalTok{ <-}\StringTok{ }\NormalTok{yrd_df[[}\DecValTok{6}\NormalTok{]]}
\NormalTok{df49_}\DecValTok{40}\NormalTok{ <-}\StringTok{ }\NormalTok{yrd_df[[}\DecValTok{5}\NormalTok{]]}
\NormalTok{df39_}\DecValTok{30}\NormalTok{ <-}\StringTok{ }\NormalTok{yrd_df[[}\DecValTok{4}\NormalTok{]]}
\NormalTok{df29_}\DecValTok{20}\NormalTok{ <-}\StringTok{ }\NormalTok{yrd_df[[}\DecValTok{3}\NormalTok{]]}
\NormalTok{df19_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\NormalTok{yrd_df[[}\DecValTok{2}\NormalTok{]]}
\NormalTok{df09_}\DecValTok{00}\NormalTok{ <-}\StringTok{ }\NormalTok{yrd_df[[}\DecValTok{1}\NormalTok{]]}
\NormalTok{df09_}\DecValTok{00} \OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(df09_}\DecValTok{00}\NormalTok{[}\StringTok{'PlayType'}\NormalTok{]}\OperatorTok{==}\StringTok{'Field Goal'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(FieldGoalResult) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{Count=}\KeywordTok{n}\NormalTok{())}\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Percentage=}\NormalTok{Count}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(Count))}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## # A tibble: 4 x 3
##   FieldGoalResult Count Percentage
##   <fct>           <int>      <dbl>
## 1 Blocked            19    0.0116 
## 2 Good             1593    0.974  
## 3 No Good            21    0.0128 
...
\begin{Highlighting}[]
\NormalTok{df09_}\DecValTok{00} \OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(df09_}\DecValTok{00}\NormalTok{[}\StringTok{'PlayType'}\NormalTok{]}\OperatorTok{!=}\StringTok{'Field Goal'} \OperatorTok{&&}\StringTok{ }\NormalTok{df09_}\DecValTok{00}\NormalTok{[}\StringTok{'PlayType'}\NormalTok{]}\OperatorTok{!=}\StringTok{'Punt'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(Touchdown) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{Count=}\KeywordTok{n}\NormalTok{())}\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Percentage=}\NormalTok{Count}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(Count))}
\end{Highlighting}
\end{Shaded}
